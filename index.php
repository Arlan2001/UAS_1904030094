...
<html lang="en">
  <head>
    ...
    <title> Sistem Informasi Akademik Unis </title>
    ...
    <!-- Custom Theme Style -->
    <link href="assets/bootstrap2/build/css/custom.min.css" rel="stylesheet">
  </head>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Universitas Islam Syekh Yusuf</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Mata Kuliah <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=tampil_matkul">Tampil Data</a></li>
                      <li><a href="index.php?page=tambah_matkul">Tambah Data</a></li>
                    </ul>
                  </li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/images.jpg" alt="">Refnandida Arlan F
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi Akademik : Refnandida Arlan F
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
